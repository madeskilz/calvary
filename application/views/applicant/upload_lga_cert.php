    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">LGA Certificate</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="row clearfix body">
                ...
                <?= form_open_multipart(base_url("applicant/upload_lga_cert"), 'class="form-horizontal col-md-12 row" ') ?>
                <div class="col-md-12 row">
                    <div class="col-md-6 row">
                        <div class="form-group col-md-12">
                            <label>Select Scanned LGA Certificate Image File</label><br />
                        ...
                        <div class="form-group col-md-12">
                            <button class="btn btn-primary">Upload LGA Certificate</button>
                        </div>
                    </div>
                    <div class="col-md-6">
