    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">JAMB Printout</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="row clearfix body">
                ...
                <?= form_open_multipart(base_url("applicant/upload_jamb_printout"), 'class="form-horizontal col-md-12 row" ') ?>
                <div class="col-md-12 row">
                    <div class="col-md-6 row">
                        <div class="form-group col-md-12">
                            <label>Select Scanned JAMB Printout Image File</label><br />
                        ...
                        <div class="form-group col-md-12">
                            <button class="btn btn-primary">Upload JAMB Printout</button>
                        </div>
                    </div>
                    <div class="col-md-6">
